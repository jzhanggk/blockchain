...
describe("NFT contract", function () {
  ...
  beforeEach(async function () {
    ...
    [owner, organizer, operator, customer1, customer2, customer3, ...customers] = await ethers.getSigners();

    NFT = await hre.ethers.getContractFactory("TicketNFT");
  ...
  describe("Festival", function () {
    it("Should transfer tickets between accounts ", async function () {
        ...
        // not enough tokens
        await expect(myNFT.transferTicket(customer1.address)).to.be.reverted;
        ...
        // expect the balance change after buying tickets
        ...
        // sell the ticket on secondary market
